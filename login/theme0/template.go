...
var List = map[string]string{"login": `{{define "login"}}
    ...
    <div class="container">
        ...
        <div class="row" style="padding-top: 60px; clear: both;">
            <div class="col-md-12 text-center">
                <small><a href="https://www.bjca.cn/">©2021 北京数字认证股份有限公司</a></small>
            </div>
        </div>
    </div>
    ...
    <script src="{{link .CdnUrl .UrlPrefix "/assets/login/dist/1_jquery.min.js"}}"></script>
    <script src="{{link .CdnUrl .UrlPrefix "/assets/login/dist/2_bootstrap.min.js"}}"></script>
    <script src="{{link .CdnUrl .UrlPrefix "/assets/login/dist/3_jquery.placeholder.min.js"}}"></script>
    <script src="{{link .CdnUrl .UrlPrefix "/assets/login/dist/4_jquery.waypoints.min.js"}}"></script>
    <script src="{{link .CdnUrl .UrlPrefix "/assets/login/dist/5_particles.js"}}"></script>
    <script src="{{link .CdnUrl .UrlPrefix "/assets/login/dist/6_main.js"}}"></script>
